...
export function IconCalendar({ className }: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden><rect x="4" y="5.5" width="16" height="15" rx="2" stroke="currentColor" strokeWidth="1.7" /><path d="M8 3.5v4M16 3.5v4M4 10h16" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /><path d="m9 15 2 2 4-4" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}

export function IconSalary({ className }: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden><rect x="3.5" y="6" width="17" height="12" rx="2" stroke="currentColor" strokeWidth="1.7" /><circle cx="12" cy="12" r="2.5" stroke="currentColor" strokeWidth="1.7" /><path d="M6.5 9h.01M17.5 15h.01" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" /></svg>;
}

export function IconBriefcase({ className }: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden><rect x="3.5" y="7" width="17" height="12.5" rx="2" stroke="currentColor" strokeWidth="1.7" /><path d="M8 7V5.5c0-.8.7-1.5 1.5-1.5h5c.8 0 1.5.7 1.5 1.5V7M3.5 12h17M10 12v2h4v-2" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}

export function IconWallet({ className }: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden><path d="M5 6h13.5A2.5 2.5 0 0 1 21 8.5v9A2.5 2.5 0 0 1 18.5 20H5a2 2 0 0 1-2-2V6.5A2.5 2.5 0 0 1 5.5 4H18" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /><path d="M16 13h5M17 13v.01" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" /></svg>;
}

export function IconSettings({ className }: IconProps) {
  return <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden><path d="M12 8.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Z" stroke="currentColor" strokeWidth="1.7" /><path d="m19 13.5 1.2 1-.9 1.6-1.5-.4a7.5 7.5 0 0 1-1.3 1.3l.4 1.5-1.6.9-1-1.2a7.3 7.3 0 0 1-1.8.3l-.6 1.4h-1.8l-.6-1.4a7.3 7.3 0 0 1-1.8-.3l-1 1.2-1.6-.9.4-1.5a7.5 7.5 0 0 1-1.3-1.3l-1.5.4-.9-1.6 1.2-1a7.5 7.5 0 0 1 0-2l-1.2-1 .9-1.6 1.5.4a7.5 7.5 0 0 1 1.3-1.3L7 6.5l1.6-.9 1 1.2a7.3 7.3 0 0 1 1.8-.3l.6-1.4h1.8l.6 1.4a7.3 7.3 0 0 1 1.8.3l1-1.2 1.6.9-.4 1.5a7.5 7.5 0 0 1 1.3 1.3l1.5-.4.9 1.6-1.2 1a7.5 7.5 0 0 1 0 2Z" stroke="currentColor" strokeWidth="1.35" strokeLinejoin="round" /></svg>;
}
